...
1~30번은 전부 완료해 `TO-DO-ARCHIVE.md`에 있다(권장 순서 14 → 16 → 2/3/4/5/10 → 20·21·22 → 8 → 25/26/27 → 11·회원 탈퇴·28·3·10·7·9·12·29·30). 31번은 실기기 확인 뒤 사용자가 UI 세부 사항 3가지를 한 번에 요청하며 시작됐다. 32번은 "JSON 내보내기랑 가져오기는 필요할까?"라는 질문에서 시작됐다.
